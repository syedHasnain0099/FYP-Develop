...
function ReportReviews() {
  ...
  const approveHandleChange = () => {
    ...
    reportingService
      .deleteReportingOfReviews(productId)
      .then((data) => {
  ...
  const disapproveHandleChange = () => {
    ...
    reportingService
      .deleteReview(data.reviewData.id)
      .then((data) => {
            ...
            <div className="col-sm-6 ">
              <div className="img_div">
                ...
                >
                  ...
                  >
                    <ProductImagesSlider
                      images={product.reviewData.productDetails.image_urls}
                    />
                    <br />
                    ...
                    <span className="description-form-input-login">
                      <NavLink
                        to={{
                          ...
                          state: {
                            video: product.reviewData.productDetails.image_urls,
                          },
                        }}
                        exact
                      >
            ...
            <div className="col-sm-6">
              <div className="product_desc_wrapper">
                <div className="product_title">
                  <h1>{product.reviewData.productDetails.name}</h1>
                  <span>
                    <h6>Reason # {product.reviewData.id}</h6>
                  </span>
                  <span>
                    <h6>Reported Review: {product.reviewData.content}</h6>
                  </span>
                  <span>
                    <h6>
                      Reporting Reason:{" "}
                      {product.reviewData.productDetails.reportingReason}
                    </h6>
                  </span>
                  <hr />
                  <h1>Rs {product.reviewData.productDetails.rent} / day</h1>
                </div>
                ...
                <div className="desc">
                  <h2>Description</h2>
                  <p>{product.reviewData.productDetails.description}</p>
                </div>
                <hr />
                <div className="desc">
                  <h2>Supplier Information</h2>
                  <p>
                    Name: {product.reviewData.productDetails.supplier.username}
                  </p>
                  <p>
                    Email: {product.reviewData.productDetails.supplier.email}
                  </p>
                  <p>
                    Contact number: +92{" "}
                    {product.reviewData.productDetails.supplier.contactNumber}
                  </p>
                </div>
                <hr />
