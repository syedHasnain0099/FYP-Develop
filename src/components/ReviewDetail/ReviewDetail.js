...
function ReviewDetail() {
  ...
  const approveHandleChange = () => {
    ...
    reportingService
      .deleteReportingOfProducts(productId)
      .then((data) => {
  ...
  const disapproveHandleChange = () => {
    ...
    productService
      .deleteProduct(data.productData.id)
      .then((data) => {
            ...
            <div className="col-sm-6 ">
              <div className="img_div">
                ...
                >
                  ...
                  >
                    <ProductImagesSlider
                      images={product.productData.image_urls}
                    />
                    <br />
                    ...
                    <span className="description-form-input-login">
                      <NavLink
                        to={{
                          ...
                          state: { video: product.productData.image_urls },
                        }}
                        exact
                      >
                ...
                <div className="review" style={{ paddingTop: "10px" }}>
                  ...
                  {product.productData.reviews &&
                    product.productData.reviews.length === 0 && (
                      <>
                        <div
                  ...
                  <div className="review_loop">
                    {product.reviews &&
                      product.productData.reviews.map((review, index) => (
            ...
            <div className="col-sm-6">
              <div className="product_desc_wrapper">
                <div className="product_title">
                  <h1>{product.name}</h1>
                  <span>
                    <h6>Reason # {product.productData.id}</h6>
                  </span>
                  <span>
                    <h6>Reporting Reason: {product.reason}</h6>
                  </span>
                  <hr />
                  <h1>Rs {product.productData.rent} / day</h1>
                </div>
                ...
                <div className="desc">
                  ...
                  <p>Name: {product.productData.supplier.username}</p>
                  <p>Email: {product.productData.supplier.email}</p>
                  <p>
                    Contact number: {product.productData.supplier.contactNumber}
                  </p>
                </div>
                <hr />
