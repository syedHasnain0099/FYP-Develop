...
function PaymentCart() {
  ...
  cart.securityFee = twoDecimalsNumber((25 / 100) * cart.itemsPrice)

  cart.shippingPrice = twoDecimalsNumber(500)
          ...
          <div className='row'>
            ...
            <div className='col-sm-4'>
              ...
              <div className='shipping_details text-center pt-3 mt-3'>
                <h4>Order Summary</h4>
                <div className='te'>
                  <b>Items price:</b> Rs.{cart.itemsPrice}
                </div>
                <div className=''>
                  <b>Security Fee:</b>Rs.{cart.securityFee}
                </div>
                <div className=''>
                  <b>Shipping Price:</b>Rs.{cart.shippingPrice}
                </div>
                <div className=''>
